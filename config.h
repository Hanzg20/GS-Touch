...
static Package PACKAGES[PACKAGE_COUNT] = {
  {"4 Min Wash", "Lavage 4 min", "4分钟洗车", 4, 4.00, 4, false},   // Nayax套餐1
  {"5 Min Wash", "Lavage 5 min", "5分钟洗车", 5, 5.00, 5, false},   // Nayax套餐2
  {"8 Min Wash", "Lavage 8 min", "8分钟洗车", 8, 8.00, 8, false},   // Nayax套餐3
  {"15 Min Wash", "Lavage 15 min", "15分钟洗车", 15, 15.00, 15, false}, // Nayax套餐4
...
static const char* TEXT_PROCESSING[] = {"Wash in Progress", "Lavage en cours", "洗车中"};
