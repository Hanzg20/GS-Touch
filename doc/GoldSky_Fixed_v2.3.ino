/*
 * Eaglson Coin Wash 洗车终端系统 - 修复版 v2.3
 * 
 * 版本: v2.3 Fixed Edition - 脉冲逻辑修复版
 * 日期: 2025-10-30
 * 作者: Eaglson Development Team
 * 
 * 🔧 v2.3 修复内容:
 * ✅ 修复脉冲发送逻辑错误（静态变量问题）
 * ✅ 脉冲仅在STATE_PROCESSING状态发送
 * ✅ 每次进入洗车状态正确重置脉冲计时器
 * ✅ 确保扣费成功后才进入准备状态
 * 
 * 🎯 完整功能列表:
...
unsigned long lastPulseTime = 0;  // ✅ 移到全局变量，便于控制
...
void setup() {
  ...
  Serial.println("Fixed Edition - 脉冲逻辑修复版");
